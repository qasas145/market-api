...
const { createReviewSchema, ReviewSchemaQuery, updateReviewSchema } = require('./review.schema');
...
async function getReviews(query) {
  const isQueryValid = await verifySchema(ReviewSchemaQuery, query);
