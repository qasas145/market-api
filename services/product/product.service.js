...
const getProducts = async (query) => {
  ...
  for (let product of products) {
    if (!product.specification) product.specification = {"name": "until i understand "} // this is not main 
    product.numViews += 1;
    await product.save();
  }
...
module.exports = { getProducts, addProduct, updateProduct, deleteProduct, getAllProducts };
